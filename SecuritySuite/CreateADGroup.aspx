...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div id="content" style="width:1000px; margin:auto auto;text-align:left;">
             <h1 style="color:#9adaf3" >Create AD Group</h1>
             <p style="color:#f9fcff">This will create user groups in Active Directory.</p>   <hr />
              <table> 
                <tr><td>
                    ...
                    <asp:Panel ID= "SinglePanel" visible="false"  runat = "server">                       
                        ...
                        <br /><br />
                        <span style="display:inline-block; width: 200px;"></span><asp:Button ID="ExecuteCreateACGGroup" cssClass="aspButton"   runat="server" Text="Create"  onclick="ExecuteCreateADGroup_Click"/>&nbsp;&nbsp;&nbsp;
                       </asp:Panel>
                        ...
                        <br /><br />
                        <span style="display:inline-block; width: 200px;"></span><asp:Button ID="ExecuteCreateAGGGroup" cssClass="aspButton"   runat="server" Text="Create"  onclick="ExecuteCreateADGroup_Click"/>&nbsp;&nbsp;&nbsp;
                       </asp:Panel>
                        ...
                        <br /><br />
                        <span style="display:inline-block; width: 200px;"></span><asp:Button ID="ExecuteCreateAPPGroup" cssClass="aspButton"   runat="server" Text="Create"  onclick="ExecuteCreateADGroup_Click"/>&nbsp;&nbsp;&nbsp;
                       </asp:Panel>
                        ...
                        <br /><br />
                        <span style="display:inline-block; width: 200px;"></span><asp:Button ID="ExecuteCreateDGGroup" cssClass="aspButton"   runat="server" Text="Create"  onclick="ExecuteCreateADGroup_Click"/>&nbsp;&nbsp;&nbsp;
                       </asp:Panel>
                        ...
                        <br /><br />
                        <span style="display:inline-block; width: 200px;"></span><asp:Button ID="ExecuteCreateDMDLGroup" cssClass="aspButton"   runat="server" Text="Create"  onclick="ExecuteCreateADGroup_Click"/>&nbsp;&nbsp;&nbsp;
                       </asp:Panel>
                        ...
                        <br /><br />
                        <span style="display:inline-block; width: 200px;"></span><asp:Button ID="ExecuteCreateRADLGroup" cssClass="aspButton"   runat="server" Text="Create"  onclick="ExecuteCreateADGroup_Click"/>&nbsp;&nbsp;&nbsp;
                       </asp:Panel>
                       ...
                       <ul class="menu">
                        ...
                        <br /><br />
                        <span style="display:inline-block; width: 200px;"></span><asp:Button ID="ExecuteCreateSMDLGroup" cssClass="aspButton"   runat="server" Text="Create"  onclick="ExecuteCreateADGroup_Click"/>&nbsp;&nbsp;&nbsp;
                       </asp:Panel>
                    </asp:Panel>
                    ...
                    <br /><br />
                     ...
                     <asp:Label runat="server" id="StatusLabel" text="Upload status: Idle" /><span style="display:inline-block; width: 50px;"></span><asp:Button ID="ExecuteCreateADGroupBulkButton" cssClass="aspButton"  visible="false" runat="server" Text="Create"  onclick="ExecuteCreateADGroupBulk_Click"/>
                     </p>
                           </div> 
                   </asp:Panel>
                   </td></tr> 
                   ...
                   <h3 style="color:#9adaf3;">Guide</h3><br /><br />
                    <p style="color:#f9fcff">&nbsp; &nbsp; For <span style="color:#ff6860;"><strong>Single</strong></span> group requests, choose the type of group you need and fill up the form and click <span style="color:#ff6860;"><strong>Create</strong></span>.</p><br />       
                    <p style="color:#f9fcff">&nbsp; &nbsp; For <span style="color:#ff6860;"><strong>Bulk</strong></span> group requests, <span style="color:#ff6860;"><strong>Import</strong></span> the bulk adgroup template and click <span style="color:#ff6860;"><strong>Create</strong></span>.</p><br /><br />
