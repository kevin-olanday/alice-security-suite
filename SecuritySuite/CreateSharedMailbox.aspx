...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div id="content" style="width:1000px; margin:auto auto;text-align:left;">
             <h1 style="color:#9adaf3" >Create Shared Mailbox</h1>
             <p style="color:#f9fcff">This will create shared mailboxes and their corresponding permission groups.</p>   <hr />
              <table> 
                <tr><td>
                    ...
                    <br /><br />
                    <span style="display:inline-block; width: 200px;"></span><asp:Button ID="ExecuteCreateSharedMailbox"  cssClass="aspButton"   runat="server" Text="Create"  onclick="ExecuteCreateSharedMailbox_Click"/>&nbsp;&nbsp;&nbsp;
