...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div id="content" style="width:1000px; margin:auto auto;text-align:left;">
             <h1 style="font-family:georgia,serif;color:#9adaf3" >Create Generic Account</h1>
             <p style="font-family:georgia,serif;color:#f9fcff">This will create generic accounts in Active Directory.</p>  
              <table> 
                <tr><td>
                    ...
                    <li>&nbsp; &nbsp; Password to set : <span style="display:inline-block; width: 40px;"></span><asp:TextBox id="genapassword" Class="formtextbox" runat="server"></asp:TextBox>&nbsp; &nbsp;<asp:Button ID="PasswordGeneratorButton"  class="formbutton" runat="server" Text="Generate"  onclick="PasswordGenerator_Click"/> (Length: &nbsp; <asp:TextBox ID="passwordlength" Class="formtextbox"  width="25px" Text="8" runat="server"></asp:TextBox> &nbsp;|&nbsp;  Special ?&nbsp;  <asp:CheckBox ID="CheckBoxSpecialChar" style="font-family:georgia,serif;" runat="server" Text="  Yes"  AutoPostBack="true" /> ) </li>  
                    <li>&nbsp; &nbsp; Is the account interactive? &nbsp; <asp:CheckBox ID="CheckBoxInteractive" style="font-family:georgia,serif;" runat="server" Text="  Yes"  AutoPostBack="true" /></li>
                    </ul>
                    <br /><br />
                    <span style="display:inline-block; width: 200px;"></span><asp:Button ID="ExecuteCreateGenericAccount" runat="server" Text="Create" Height="30" Width="175" style="font-family:verdana,geneva,sans-serif;" onclick="ExecuteCreateGenericAccount_Click"/>&nbsp;&nbsp;&nbsp;
                    ...
                    <br /><br />
                     ...
                     <asp:Label runat="server" id="StatusLabel" text="Upload status: Idle" /><span style="display:inline-block; width: 50px;"></span><asp:Button ID="ExecuteCreateGenericAccountBulkButton" visible="false" runat="server" Text="Create" Height="30" Width="175" style="font-family:verdana,geneva,sans-serif;" onclick="ExecuteCreateGenericAccountBulk_Click"/>
                     </p>
                           </div> 
                   </asp:Panel>
                ...
                <tr><td style="font-family:georgia,serif;color:#f9fcff"><br /><br />
                    ...
                    <p style="font-family:georgia,serif;color:#f9fcff">&nbsp; &nbsp; For <span style="color:#ff6860;"><strong>Single</strong></span> generic account requests, simply fill up the form and click <span style="color:#ff6860;"><strong>Create</strong></span>.</p><br />       
                    <p style="font-family:georgia,serif;color:#f9fcff">&nbsp; &nbsp; For <span style="color:#ff6860;"><strong>Bulk</strong></span> generic account requests, <span style="color:#ff6860;"><strong>Import</strong></span> the bulk generic account template and click <span style="color:#ff6860;"><strong>Create</strong></span>.</p><br /><br />
