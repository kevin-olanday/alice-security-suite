...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div id="content" style="width:1000px; margin:auto auto;text-align:left;">
             <h1 style="color:#9adaf3" >Create Resource Calendar</h1>
             <p style="color:#f9fcff">This will create  calendar resources and their corresponding permission groups.</p>  <hr /> 
              <table> 
                <tr><td>
                    ...
                    <br /><br />
                    <span style="display:inline-block; width: 200px;"></span><asp:Button ID="ExecuteCreateSharedCalendar" cssClass="aspButton"  runat="server" Text="Create"  onclick="ExecuteCreateSharedCalendar_Click"/>&nbsp;&nbsp;&nbsp;
                   ...
                   <p style="color:#f9fcff">&nbsp; &nbsp;Choose whether you want to create a single mailbox or otherwise. <br />&nbsp; &nbsp;Fill up the form and click <span style="color:#ff6860;"><strong>Create</strong></span> to create the shared mailbox/es.</p>       
                   </td></tr>
