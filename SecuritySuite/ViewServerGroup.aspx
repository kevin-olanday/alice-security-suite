...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div id="content" style="width:1000px; margin:auto auto;text-align:left;">
             <h1 style="color:#9adaf3" >View Server Groups</h1>
             <p style="color:#f9fcff">This will display SGG Groups associated with the server. Useful for checking if Elevated access groups exist.</p>   <hr />
              <table> 
                <tr><td>
                    <p style="color:#f9fcff">
                    Enter Server here : &nbsp;<asp:TextBox ID="Input" runat="server"></asp:TextBox> &nbsp; &nbsp; &nbsp;
                   <asp:Button ID="ExecuteViewServerGroup" cssClass="aspButton"  runat="server" Text="Check"  onclick="ExecuteViewServerGroup_Click"/>&nbsp;&nbsp;&nbsp;
                    </p>
                </td></tr> 
                <tr><td style="color:#f9fcff"><br /><br />
                    ...
                    <p style="color:#f9fcff">&nbsp; &nbsp;Enter the UNC path and click <span style="color:#ff6860;"><strong>Check</strong></span> to see the available SGG Groups.</p>
                    <br />
                    <p style="color:#f9fcff">&nbsp; &nbsp;If you need to create WF or WO Groups, you may do so by going <strong><a href="CreateFolderPermissionGroup.aspx" style="text-decoration:none;color:#DF691A">here.</a></strong></p>       
                    </td></tr>
