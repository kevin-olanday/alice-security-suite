...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
      <div style="width:1000px; margin:0 auto;text-align:left;">
         <h1 style="color:#9adaf3" >Check Folder Approvers</h1>
         <p style="color:#f9fcff">This will query a directory and output the corresponding approvers and permission groups.</p>   <hr />
          <table> 
            <tr><td>
               ...
               <asp:Button ID="ExecuteCodeLAN" cssClass="aspButton"   runat="server" Text="Check"  onclick="ExecuteCheckFolderApprovers_Click"/>&nbsp;&nbsp;&nbsp; <br /><br />                  
                ...
                <tr><td><br />
                     <div style="float:left;margin-left: 50px;">
                      <asp:Panel ID= "ResultPanel" visible="false"  runat = "server">
                        ...
                        <asp:TableRow ID="TableRow1" HorizontalAlign="center" runat="server" ForeColor="#f9fcff">
                ...
                <p style="color:#f9fcff">&nbsp; &nbsp;Enter the UNC path and click <span style="color:#ff6860;"><strong>Check</strong></span> to obtain the approvers for that directory. </p> <br/>       
                <p style="color:#f9fcff">&nbsp; &nbsp;The tool will also suggest permission groups for both read only and read/write access. </p> <br/>       
                 </td></tr>
           </table>
       </div>
</asp:Content>