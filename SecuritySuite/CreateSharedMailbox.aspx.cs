...
namespace ExecutionCreateSharedMailbox
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void ExecuteCreateSharedMailbox_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                shell.Commands.AddScript("C:\\Scripts\\Powershell\\ALICECreateSharedMailbox.ps1 -mailboxname " + "'" + MailboxName.Text + "'" + " -alias " + "'" + Alias.Text + "'" + " -inc " + INC.Text + " -owner " + "'" + Owner.Text + "'" + "-pbo " + "'" + PBO.Text + "'" + " -group " + "'" + Group.Text + "'" + " -approvers " + "'" + Approvers.Text + "'" + " -fullaccessmembers " + "'" + FullAccessMembers.Text + "'");
                //shell.Commands.AddScript("C:\\Scripts\\Powershell\\ALICEExchangeTest.ps1");
